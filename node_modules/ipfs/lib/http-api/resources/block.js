...
exports.get = {
  ...
  handler: function handler(request, reply) {
    ...
    request.server.app.ipfs.block.get(key, function (err, block) {
      if (err) {
        log.error(err);
        return reply({
...
exports.put = {
  ...
  handler: function handler(request, reply) {
    ...
    request.server.app.ipfs.block.put(block, function (err) {
      if (err) {
        log.error(err);
        return reply({
...
exports.del = {
  ...
  handler: function handler(request, reply) {
    ...
    request.server.app.ipfs.block.del(key, function (err, block) {
      if (err) {
        log.error(err);
        return reply({
...
exports.stat = {
  ...
  handler: function handler(request, reply) {
    ...
    request.server.app.ipfs.block.stat(key, function (err, block) {
      if (err) {
        log.error(err);
        return reply({
